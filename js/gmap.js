    ...
    function deetcallback(deetplace, status) {
        if (status == google.maps.places.PlacesServiceStatus.OK) {
            ...
            if (deetplace.photos.length < 4){
                photoHtml = '<img class="imgSlider" src="' + deetplace.photos[0].getUrl({'maxWidth': 200, 'maxHeight': 150}) + '"></img>';
                ...
                photoHtml = '<img class="imgSlider" src="' + deetplace.photos[0].getUrl({'maxWidth': 200, 'maxHeight': 150}) + '"></img>' + '<img class="imgSlider" src="' + deetplace.photos[1].getUrl({'maxWidth': 200, 'maxHeight': 150}) + '"></img>' + '<img class="imgSlider" src="' + deetplace.photos[2].getUrl({'maxWidth': 200, 'maxHeight': 150}) + '"></img>' + '<img class="imgSlider" src="' + deetplace.photos[3].getUrl({'maxWidth': 200, 'maxHeight': 150}) + '"></img>';
                placesList.innerHTML += '<p class="' + place.types[0] + '">' + '<a href="tel:' + deetplace.formatted_phone_number + '"><i class="material-icons">phone</i></a> <a href="' + deetplace.website + '" target="_blank"><i class="material-icons">public</i></a>' + '</p>';
