...
function createMarker(place) {
    ...
    placesList.innerHTML += '<p class="' + place.types[0] + '">' + '<a href="https://maps.google.com/maps?q=' + place.formatted_address + '"><i class="material-icons">add location</i><br/>' + place.formatted_address + '</a>' + '</p>';
